          ...
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              {[
                ...
                { img: "/images/app-mockup.png", step: "03", title: "მოიგე ქეშბექი", desc: "დაიბრუნე შენაძენის 100%-მდე თანხა. გამოიტანე ნებისმიერ დროს, ყოველგვარი პირობების გარეშე.", imgSize: 120 },
              ].map((s, i) => (
                <div
                  key={i}
