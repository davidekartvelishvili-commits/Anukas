        ...
        <section className="py-20 md:py-28 px-6" style={{ background: "#F9E741" }}>
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8">
              {[
                { img: "/images/app-cashback.png", step: "01", title: "დაასკანერე QR კოდი",   desc: "ეწვიეთ პარტნიორ ობიექტს და დაასკანერეთ QR კოდი თქვენი შენაძენის დასაფიქსირებლად.", imgSize: 140 },
